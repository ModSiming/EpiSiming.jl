...
6×12 Matrix{Vector{Int64}}:
 [8, 19, 28, 19, 4, 4, 1, 1]  …  [1, 2, 4, 2, 0, 0, 0, 0]
 [3, 7, 10, 7, 1, 2, 1, 0]       [6, 15, 21, 13, 4, 3, 1, 0]
 [2, 6, 8, 5, 1, 2, 0, 0]        [7, 14, 22, 16, 3, 4, 1, 0]
 [4, 11, 15, 9, 3, 2, 0, 0]      [8, 16, 27, 16, 3, 3, 1, 0]
 [6, 13, 20, 12, 2, 3, 1, 0]     [5, 12, 18, 10, 3, 2, 0, 0]
 [4, 11, 16, 11, 2, 2, 0, 0]  …  [7, 12, 17, 12, 2, 2, 0, 0]
```
...
```
1.772811 seconds (22.32 k allocations: 12.942 MiB)
  0.188167 seconds (2 allocations: 19.766 KiB)
360×7 Matrix{Int64}:
 9980  20   0   0     0  0  0
 9980  13   2   5     0  0  0
 9976  12   4   7     1  0  0
